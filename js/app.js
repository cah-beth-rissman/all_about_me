...
if(toLowerCaseName === 'beth' || toLowerCaseName === 'eva' || toLowerCaseName === 'leah' || toLowerCaseName === 'craig' || toLowerCaseName === 'katie' || toLowerCaseName === 'ruthann'){
  alert('Welcome back to my All About Me site, ' + userName + '! Let\'s play a guessing game. Each questions you get correct, earns you a point! Please respond with Y or N.');
} else {
  alert('Welcome, ' + userName + '! Let\'s play a guessing game. Each question you get correct, earns you a point! Please respond with Y or N.');
}
}
getUserName();
...
if(toLowerCaseTravelInfo === 'n' || toLowerCaseTravelInfo === 'no'){
  alert('That is incorrect, ' + userName + ' I am always looking for my next adventure!');
} else {
...
function getFavNumber() {
  ...
  while(favNumber !== '16' && loopcounter<5){
    loopcounter ++;
    favNumber = prompt('What\'s my favorite number? Guess a number between 1-20 in five or fewer attempts.');
    if (favNumber >'16'){
  ...
  function getCookieInfo() {
    ...
    while (attempts !==6 && correctAnswer === false){
      let cookieInfo = prompt('Cookies are a sweet treat. Guess one of my favorite cookie flavors.');
      ...
      if (cookieInfo.indexOf(cookieInfo) >= 0) {
        ...
        correctAnswer=true;
        alert('Correct, a ' + cookieInfo + ' cookie is one of my favorite cookies to eat. Chocolate chip, sugar, monster, snickerdoodle and shortbread cookies are all great flavors.');
      } else {
  ...
  alert('Hello ' + userName + ', you learned a few things about me and earned some points! You earned ' + userPoints + ' , great job!');
